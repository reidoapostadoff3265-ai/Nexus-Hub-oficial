...
local Window = redzlib:MakeWindow({
  ...
  Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://6518796530", BackgroundTransparency = 0 },
...
Tab1:AddDiscordInvite({
    ...
    Logo = "rbxassetid://",
    Invite = "https://discord.gg/S87m5mBcRy",
})
...
Tab11:AddButton({
    Name = "Drip Lite – Painel Adm",
    Description = "Somente para Brookhaven",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/reidoapostadoff3265-ai/Painel-Adm-Drip-Lite/refs/heads/main/main.lua"))()
    end
})
